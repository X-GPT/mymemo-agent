...
export class InvalidAgentCoreDispatchEnvelopeError extends Error {
	override readonly name = "InvalidAgentCoreDispatchEnvelopeError";
}
...
export function parseAgentCoreDispatchEnvelope(
	...
	const invalid = () =>
		new InvalidAgentCoreDispatchEnvelopeError(
...
export function sameAgentCoreDispatch(
