...
- **chat-api** (`apps/chat-api/`) - AI chat service; owns conversation creation, queued run insertion, durable SSE projection over Postgres `run_events`, and best-effort merging of cursorless Live preview on the original request
