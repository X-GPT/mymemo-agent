locals {
  ...
  runtime_environment = {
    ...
    CANARY_OPENROUTER_API_KEY_SECRET_ARN = var.openrouter_api_key_secret_arn
    CANARY_E2B_API_KEY_SECRET_ARN        = var.e2b_api_key_secret_arn
    CANARY_REDIS_URL_SECRET_ARN          = var.redis_url_secret_arn
